...
@InputType({
  description:
    '스티커들의 자세한 정보를 받기위해 입력하는 입력값입니다. populate를 통해 _id값 이외의 자세한 데이터를 받아올 수 있으며, mode를 통해 스티커 종류별로 그룹화 시킬 수 있습니다. default가 아닌 모드는 populate:true 설정이 필수입니다. ',
})
export class PopulateStickerInput {
  @Field(type => StickerMode, {
    ...
    defaultValue: StickerMode.group,
    nullable: true,
  })
  mode?: StickerMode;
}
